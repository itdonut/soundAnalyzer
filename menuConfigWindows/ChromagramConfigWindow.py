...
from data.ChromagramConfigWindowData import ChromagramConfigWindowData
from PySide6.QtWidgets import QFileDialog


class ChromagramConfigWindow(MenuConfigWindow):
    def __init__(self, uiClass, callbackDoneFunc=None):
        super().__init__(uiClass)
        self.__data = ChromagramConfigWindowData()
