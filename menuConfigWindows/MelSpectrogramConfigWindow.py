...
from data.MelSpectrogramConfigWindowData import MelSpectrogramConfigWindowData
from PySide6.QtWidgets import QFileDialog


class MelSpectrogramConfigWindow(MenuConfigWindow):
    def __init__(self, uiClass, callbackDoneFunc=None):
        super().__init__(uiClass)
        self.__data = MelSpectrogramConfigWindowData()
